            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input disabled type="number" class="form-control" id="storeHeader" value="570">
                    </div>
...
<script>
    window.assignPartida.init({
        importUrl: "{{ url('/api/sears/assign-partida/import') }}",
        analyzeUrl: "{{ url('/api/sears/assign-partida/analyze') }}",
        executeUrl: "{{ url('/api/sears/assign-partida/execute') }}",
